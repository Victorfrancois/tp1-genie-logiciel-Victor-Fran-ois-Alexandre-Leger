...
public class System_hospitalier {
	...
	private String analyserRequete(Requête requête) {
		// Analyser la requête
		//la methode renvoie une chaine de charactere  pour signaler que la requete a ete analyser             
		return "requête analysée";
	}
	
	private String comparerDonnes() {
		// Comparaison des données
		// la methode signale que le cluster a ete trouve en renvoyant une chaine de charactere 
